...
const { authenticateUser, isAdmin } = require("../middleware/mbaAuth");

// Every route below requires a valid, logged-in admin. This replaces the
// old setup where the only protection was the frontend hiding the /admin
// link (VITE_ADMIN_EMAIL) -- that never actually stopped a direct API call.
